...
gprMdl = fitrgp([train_data.normalized_inputs; cv_data.normalized_inputs],...
        [train_data.normalized_young; cv_data.normalized_young],...
...
gprMdl1 = fitrgp(train_data.normalized_inputs,...
        train_data.normalized_young,... %'KernelFunction','ardsquaredexponential',...
        'KernelFunction',GPR_kernel,...
        'FitMethod','sr','PredictMethod','fic','Standardize',1);
cv_data.pred = predict(gprMdl1,cv_data.inputs);
cv_data.error = cv_data.normalized_young - cv_data.pred;
